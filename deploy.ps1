# Build and deploy the static site to atelier.yusupov.cloud.
#   usage:  .\deploy.ps1
# The server (ssh alias "yusupov", port 2708) serves the site root from
# /home/django/atelier-yusupov. Pure static: build -> pack -> upload -> extract.
...
$Remote = "yusupov"
$Port   = 2708
$Dest   = "/home/django/atelier-yusupov"
...
Write-Host "deployed -> https://atelier.yusupov.cloud" -ForegroundColor Green
